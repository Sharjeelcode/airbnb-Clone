...
function AdsDetail() {
  ...
  const { FireStoreDataFetch } = useFireStoreData();
  ...
  useEffect(() => {
    adsData && adsData[adsDetail] && adsData[adsDetail].placeName != undefined
      ? setloading(false)
      : setloading(true);
  }, [adsData, adsData[adsDetail]]);

  return (
    <>
      {adsData &&
      adsData[adsDetail] &&
      adsData[adsDetail].placeName != undefined ? (
