      ...
      <div className="z-50  sticky bg-white top-0 border-b-2 md:pb-2 md:block">
        <div className=" px-1 md:px-10 h-16 flex items-center justify-between">
          ...
          <div className="hidden  lg:flex w-96  justify-around ">
            <span className="rounded-full cursor-pointer px-4 py-2 hover:bg-gray-100 hover:text-black">
              Stays
            </span>
            <span className="rounded-full cursor-pointer text-gray-400 px-4 py-2 hover:bg-gray-100 hover:text-black">
              Experiences
            </span>
            <span className="rounded-full cursor-pointer text-gray-400  px-4 py-2 hover:bg-gray-100 hover:text-black">
              Online Experiences
          ...
          <div className="flex items-center gap-3">
            ...
            <svg
              ...
              role="presentation"
              focusable="false"
              className="hidden md:block w-4 h-6 mr-2"
            >
