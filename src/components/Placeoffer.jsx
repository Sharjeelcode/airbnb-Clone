  ...
  return (
    <div className="grid grid-cols-2 ">
      <div className="flex gap-2 mb-4  ">
        ...
        <h1 className="font-normal text-gray-600">Lock on bedroom door</h1>
      </div>
      <div className="flex gap-2 mb-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 className="font-normal text-gray-600">Mountain view</h1>
      </div>
      ...
      <div className="flex gap-2 mb-4">
        ...
        <h1 className="font-normal text-gray-600">Kitchen</h1>
      </div>
      <div className="flex gap-2 mb-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 className="font-normal text-gray-600">Wifi</h1>
      </div>
      <div className="flex gap-2 mb-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 className="font-normal text-gray-600">Pets allowed</h1>
      </div>
      <div className="flex gap-2 mb-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 className="font-normal text-gray-600">Shared patio or balcony</h1>
      </div>
      <div className="flex gap-2 mb-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 className="font-normal text-gray-600">Firepit</h1>
      </div>
      <div className="flex gap-2 mb-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 className="font-normal text-gray-600 line-through">
      ...
      <div className="flex gap-2 mb-4">
        ...
        <h1 className="font-normal text-gray-600 line-through">Smoke alarm</h1>
      </div>
      <div className="flex gap-2 mb-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h1 className="font-normal text-gray-600 ">BBQ grill</h1>
      </div>
    </div>
  );
}
